...
if(isset($_POST['MM_update']) && $_POST['MM_update'] == "UPDATE"){
  $sql= "UPDATE product_category SET category =:category,
            updatedDate = :updatedDate WHERE product_categoryID=:product_categoryID";
  $sth = $db ->prepare($sql);
...
$sth = $db->query("SELECT * FROM product_category WHERE product_categoryID=".$_GET['product_categoryID']);
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator" action="edit.php" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control"  id="category" name="category" value="<?php echo $product_category['category']; ?>"  data-error="請輸入分類名稱"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2 text-right">
                  <input type="hidden" class="form-control" id="product_categoryID" name="product_categoryID" value="<?php echo $product_category['product_categoryID'];?>">
