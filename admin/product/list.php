            ...
            <table class="table">
              ...
              <?php if($totalRaws > 0){ ?>
                ...
                <tr>
                  ...
                  <td><a href="edit.php?product_categoryID=<?php echo $_GET['product_categoryID']; ?>&productID=<?php echo $row['productID'];?>" class="btn btn-primary">編輯</a></td>
                  <td><a href="delete.php?product_categoryID=<?php echo $_GET['product_categoryID']; ?>&productID=<?php echo $row['productID'];?>" onclick="if(!confirm('是否刪除此筆資料？')){return false;};" class="btn btn-primary">刪除</a></td>
                </tr>
              <?php } ?>
            <?php }else{ ?>
              <tr>
