...
if(isset($_POST['MM_update']) && $_POST['MM_update'] == "UPDATE"){
  ...
  $sql= "UPDATE q_a SET Q =:Q,
            A = :A,
            updatedDate = :updatedDate WHERE q_aID=:q_aID";
  $sth = $db ->prepare($sql);

  $sth ->bindParam(":Q", $_POST['Q'], PDO::PARAM_STR);
  $sth ->bindParam(":A", $_POST['A'], PDO::PARAM_STR);
  $sth ->bindParam(":updatedDate", $_POST['updatedDate'], PDO::PARAM_STR);
  $sth ->bindParam(":q_aID", $_POST['q_aID'], PDO::PARAM_INT);
  $sth ->execute();

  header("Location: list.php?q_a_categoryID=".$_POST['q_a_categoryID']);
}
$sth = $db->query("SELECT * FROM q_a WHERE q_aID=".$_GET['q_aID']);
$q_a = $sth->fetch(PDO::FETCH_ASSOC);
  ...
  tinymce.init({
    ...
    <div class="section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator" method="post" action="edit.php" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="Q" name="Q" value="<?php echo $q_a['Q']; ?>" data-error="請輸入價格" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="A" name="A"><?php echo $q_a['A']; ?></textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2 text-right">
                  ...
                  <input type="hidden" name="q_aID" value="<?php echo $q_a['q_aID']; ?>">
