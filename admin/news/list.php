            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="edit.php?newsID=<?php echo $row['newsID'];?>" class="btn btn-primary" role="button">編輯</a></td>
                  <td><a href="delete.php?newsID=<?php echo $row['newsID'];?>" onclick="if(!confirm('是否刪除此筆資料？')){return false;};" class="btn btn-primary" role="button">刪除</a></td>
                </tr>
              <?php } ?>
              </tbody>
            </table>
